                ...
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6 lg:gap-6">
                    {superSecuritePartners.map((partner, index) => (
                        <Reveal key={partner.name} delay={index * 80}>
                            <figure className="group flex h-28 flex-col items-center justify-center rounded-2xl border border-super-securite-border bg-white p-4 shadow-sm shadow-slate-900/5 transition-colors duration-300 hover:border-super-securite-accent/30 md:h-32">
                                <img
                                    src={partner.logo}
